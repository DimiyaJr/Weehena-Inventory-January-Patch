...
export const LoginForgotPasswordModal: React.FC<LoginForgotPasswordModalProps> = ({ isOpen, onClose }) => {
    ...
    try {
      ...
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          status: 'pending',
          request_message: message || 'User forgot password and requesting reset from login page'
        });
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>
                    Enter your username to request a password reset. A Super Admin will create a new temporary password and contact you.
                  </p>
                </div>
              </div>
            </div>
